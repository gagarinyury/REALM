...
class WidowX(Robot):
    ...
    def usd_path(self):
        ...
        return os.path.join(gm.ASSET_PATH, f"/app/realm/robots/widowx/widowx.usd")

    @property
    def robot_arm_descriptor_yamls(self):
        #return {self.default_arm: os.path.join(gm.ASSET_PATH, "models/vx300s/vx300s_description.yaml")}
        return {self.default_arm:os.path.join(gm.ASSET_PATH, f"/app/realm/robots/widowx/widowx_description.yaml")}

    @property
    def urdf_path(self):
        #return os.path.join(gm.ASSET_PATH, "models/vx300s/vx300s.urdf")
        return os.path.join(gm.ASSET_PATH, f"/app/realm/robots/widowx/widowx.urdf")
